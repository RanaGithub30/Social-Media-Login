...
<body>
    <div class="zufilist-container">
        <h1>Social Login</h1>
        <a class="github-btn" href="/sign-in/github" target="_blank">
        ...
        <a class="google-btn" href="/sign-in/google" target="_blank">
        ...
        <a class="google-btn" href="/sign-in/facebook" target="_blank">
